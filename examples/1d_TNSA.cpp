...
int main(int narg, char **args)
{
    ...
    plasma1.setXRangeBox(0.0,1.5);                  //double (* distrib_function)(double x, double y, double z, PLASMAparams plist, int Z, int A)
    ...
    plasma1.setRampLength(0.5);                       //ramp_min_density,void *additional_params
    ...
    plasma2.setXRangeBox(1.5,1.505);                  //double (* distrib_function)(double x, double y, double z, PLASMAparams plist, int Z, int A)
    ...
    electrons1.setParticlesPerCellXYZ(300, 1, 1);       //Se < 1 il nPPC viene sostituito con 1
    ...
    electrons2.setParticlesPerCellXYZ(300, 1, 1);       //Se < 1 il nPPC viene sostituito con 1
